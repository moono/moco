...
from two_image_data_loader import CustomDataset
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = CustomDataset(traindira, traindirb)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images_a, images_b) in enumerate(train_loader):
        ...
        # compute output
        output, target = model(im_q=images_a, im_k=images_b)
        ...
        top1.update(acc1[0], images_a.size(0))
        top5.update(acc5[0], images_a.size(0))
